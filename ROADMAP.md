...
| The label-audit scoring sample | `data/label_audit_sample/label-1.0_sheet.csv` | 60 rows, 1 scored | 2026-08-24 | nothing now — the audit has run corpus-wide since; scoring it would measure the prompt, and the row can be dropped |
